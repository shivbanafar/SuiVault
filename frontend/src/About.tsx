...
export function About() {
  ...
  const features = [
    ...
    {
      id: "encryption",
      icon: <LockIcon className="w-6 h-6 text-[#00ADB5]" />,
    ...
    {
      id: "management",
      icon: <FileIcon className="w-6 h-6 text-[#00ADB5]" />,
    ...
    {
      id: "smart-contracts",
      icon: <CodeIcon className="w-6 h-6 text-[#00ADB5]" />,
    ...
    {
      id: "interface",
      icon: <GlobeIcon className="w-6 h-6 text-[#00ADB5]" />,
    ...
    {
      id: "security",
      icon: <KeyIcon className="w-6 h-6 text-[#00ADB5]" />,
    ...
    {
      id: "performance",
      icon: <ZapIcon className="w-6 h-6 text-[#00ADB5]" />,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {features.map((feature) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
            >
              <Card className="h-full border border-[#393E46] bg-[#222831]/80 hover:bg-[#222831] transition-all duration-200">
                <CardHeader className="p-6">
                  <div className="flex items-start gap-5">
                    <div className="bg-[#00ADB5]/10 p-4 rounded-xl">
                      {feature.icon}
                    </div>
              ...
              >
                ...
                <CardHeader className="p-8">
                  <div className="flex items-start gap-6 pr-12">
                    <div className="bg-[#00ADB5]/10 p-5 rounded-xl">
